...
class WxMchPay extends WxPayDataBase
{
     ...
     * @return mixed
     */
    public function IsSetPartnerTradeNo()
    {
     ...
     * 获取Ip地址
     */
    public function GetSpillCreateIp()
    {
        return $this->values["spbill_create_ip"];
    }
     ...
     * Ip地址是否存在
     */
    public function IsSpillCreateIpSet()
    {
        return array_key_exists('spbill_create_ip', $this->values);
    }
}
 ...
 *
 */
class WxGetPublic extends WxPayDataBase
{
    /**
     * 设置商户号
     * @param string $value
 ...
 *
 */
class WxMchPayBank extends WxPayDataBase
{
    ...
    /**
     * 设置银行卡号
     * @param string $value 加密后的base字符串
     **/
